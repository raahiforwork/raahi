        ...
        (result, status) => {
          if (status === "OK" && result?.routes?.[0]?.legs?.[0]) {
            ...
            if (durationSeconds) {
              ...
              const formattedArrival = arrivalTimestamp.toLocaleTimeString([], {
                hour: "2-digit",
                minute: "2-digit",
              });
              resolve(formattedArrival);
            } else {
              resolve("Unknown");
            }
          } else {
...
export default function ModernDashboard() {
  ...
  const filteredRides = useMemo(() => {
    ...
    return allAvailableRides.filter(
      (ride) =>
  ...
  const handleCreateRide = async () => {
    ...
    const toTime = await getEstimatedArrivalTime(
      createRideForm.from,
      createRideForm.to,
      departure,
    );
          ...
          <div className="p-3 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm rounded-2xl border border-green-800/20 p-4 sm:p-6 lg:p-8 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                ...
                <Button className="py-3 sm:py-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105 col-span-1 sm:col-span-2 lg:col-span-1 text-sm sm:text-base">
          ...
          createdRide ? (
            <div className="p-3 sm:p-6 lg:p-8">
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm rounded-2xl border border-green-800/20 p-4 sm:p-6 lg:p-8 shadow-xl">
                ...
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-2xl border border-gray-700/30 p-4 sm:p-6 lg:p-8 shadow-lg">
                  <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 mt-1 text-sm sm:text-base">Ride Creator</p>
                      </div>
                    </div>

                    {/* Route Info */}
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 items-center">
                      <div className="text-center p-3 sm:p-4 bg-gray-800/30 rounded-xl">
                      ...
                      <div className="flex items-center justify-center order-3 sm:order-2">
                        <div className="flex items-center space-x-1 sm:space-x-3">
                          ...
                          <div className="w-12 sm:w-20 h-1 bg-gradient-to-r from-green-400 via-blue-400 to-purple-400 rounded-full" />
                          <Car className="h-4 w-4 sm:h-6 sm:w-6 text-blue-400" />
                          <div className="w-12 sm:w-20 h-1 bg-gradient-to-r from-purple-400 via-blue-400 to-green-400 rounded-full" />
                          <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-400 rounded-full animate-pulse" />
                        </div>
                      </div>

                      <div className="text-center p-3 sm:p-4 bg-gray-800/30 rounded-xl order-2 sm:order-3">
                        <p className="text-xl sm:text-2xl font-bold text-white mb-1">
                          {createdRide.toTime}
                        </p>
                        <p className="text-xs sm:text-sm text-gray-400 truncate">
                    ...
                    <div className="flex flex-col items-center lg:items-end space-y-3 sm:space-y-4">
                      <div className="text-center lg:text-right p-3 sm:p-4 bg-gray-800/30 rounded-xl w-full lg:w-auto">
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="flex items-center justify-center lg:justify-end text-xs sm:text-sm mb-2">
                      ...
                      <div className="flex space-x-2 sm:space-x-3 w-full lg:w-auto">
                        <Button
                          size="sm"
                          className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm flex-1 lg:flex-none"
                        ...
                        <Button
                          size="sm"
                          className="bg-red-600 hover:bg-red-700 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm flex-1 lg:flex-none"
                  ...
                  {createdRide.preferences?.length > 0 && (
                    <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-700/30">
                      <h5 className="text-white font-semibold mb-3 flex items-center text-sm sm:text-base">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {createdRide.preferences.map((pref, index) => (
                          <Badge
                            key={index}
                            variant="outline"
                            className="border-green-500/30 bg-green-500/10 text-green-300 px-2 sm:px-3 py-1 text-xs"
                          >
                            {pref}
                          </Badge>
                        ))}
        ...
        {activeTab === "my-rides" && (
          <div className="p-3 sm:p-6 lg:p-8">
            <div className="text-center py-8 sm:py-12 lg:py-16">
              <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 flex items-center justify-center shadow-2xl">
              ...
              <Button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
          ...
          <div className="p-3 sm:p-6 lg:p-8">
            <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm rounded-2xl border border-orange-800/20 p-4 sm:p-6 lg:p-8 shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                {/* Settings & Actions */}
                <div className="space-y-6">
                  <h5 className="text-lg font-semibold text-white">Settings & Actions</h5>
