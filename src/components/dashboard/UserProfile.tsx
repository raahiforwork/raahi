          ...
          <div className="space-y-6">
            ...
            {editMode ? (
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-semibold text-orange-400 mb-2 block">
                    First Name
                  </label>
                  <Input
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-gray-800/30 rounded-xl">
                    {rideStats.loading ? (
                      <div className="animate-pulse">
                        <div className="h-6 w-8 bg-gray-700 rounded mx-auto mb-2"></div>
                      ...
                      <>
                        ...
                        <p className="text-sm text-gray-400">Rides Booked</p>
                      </>
                    )}
                  </div>
                  <div className="text-center p-4 bg-gray-800/30 rounded-xl">
