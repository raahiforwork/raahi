...
const extractMainLocation = (address: string) => {
  ...
  const mainPart = parts.find(part => 
    part.length < 50 && 
    !part.match(/^\d/) && 
    !part.includes('India') && 
    part.length > 3 
      ...
      <div className="p-5 sm:p-6 md:p-7 pt-14">
        ...
        <div className="flex items-start justify-between mb-5 sm:mb-6 gap-4 min-h-[60px]">
          ...
          <div className="text-right flex-shrink-0 min-w-[80px]">
            ...
            <div className="text-xs text-gray-400 whitespace-nowrap">per person</div>
          </div>
        </div>
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-2 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-white text-xs sm:text-sm truncate" title={ride.from}>
              ...
              <div className="flex items-center space-x-2 flex-1 min-w-0">
                <div className="flex-1 min-w-0 text-right">
                  <p className="font-medium text-white text-xs sm:text-sm truncate" title={ride.to}>
